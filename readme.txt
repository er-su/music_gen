...
run git clone https://github.com/er-su/music_gen.git
...
run python df.py --lookback 5 --output-type <chordify_int|chordify_roman|12note> --surname <surname>
-l 5: Sequence length parameter.
--output-type: Format for representation (chordify_roman for SVM and decision tree and chordify_int for XGBoost).
